...
namespace Effect.Enemy
{
    ...
    /// 分裂敌人的动作类,用于生成新的敌人
    /// </summary>
    public class SplitEnemyEffect : EffectBase
    {
        /// <summary>
        /// 要生成的敌人ID
        /// </summary>
        ...
        public SplitEnemyEffect(SkillInfo skillInfo)
        {
        ...
        public SplitEnemyEffect(string spawnEnemyId, global::Characters.Enemy.Enemy sourceEnemy)
        {
